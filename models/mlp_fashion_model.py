...
# MLP-Modell - Multiple Layer Perceptron
class FashionMNIST_MLP(nn.Module):              # nn. Module ist die Hauptklasse, auf der alle neuronalen Netzwerkmodelle in PyTorch basieren./ inheritance
    def __init__(self):
        ...
        # Ausgangsschicht: 64 ist die Ausgabe der verborgenen Schicht und 10 ist die Klassennummer. (Denn es gibt 10 Kurse bei FashionMNIST!)
        self.fc3 = nn.Linear(64, 10)

    # def Forward definiert den Übergang des Modells von der Eingabe zur Ausgabe. Mit Eingabe "x"
    def forward(self, x):
        # Flatten: MLP funktioniert nur mit Vektoren (eindimensionale Listen) damm flatten wir bild zu vektor!
        # Das Ziel hier vom 4D zu 1D zu machen: (64, 1, 28, 28) → (64, 784)
        x = x.view(x.size(0),-1)
